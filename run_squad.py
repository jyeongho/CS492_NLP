...
from model_electra import ElectraForQuestionAnswering
...
'''
Train intensive Reading Module of retrospective paper.
Using ElectraForQuestionAnswering model, 
this function does training by QA task.
After training, the output of ElectraForQuestionAnswering model will be used to calculating diff score and predicting answer.
Reference : https://github.com/cooelf/AwesomeMRC/blob/master/transformer-mrc/examples/run_squad_seq_sc.py
'''
...
def main():
    ...
    model = ElectraForQuestionAnswering.from_pretrained("monologg/koelectra-small-v3-discriminator")
